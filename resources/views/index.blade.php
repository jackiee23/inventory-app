                                ...
                                <div class="bg-gradient-primary border-radius-lg h-100">
                                    ...
                                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                        <img class="w-100 position-relative z-index-2 pt-4"
                                            src="{{ asset('dashboard/img/illustrations/rocket-white.png') }}"
                                            alt="rocket">
                                    </div>
                                </div>
                            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row d-flex">
                ...
                <div class="col-lg-7">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores doloribus quisquam exercitationem
                        nostrum. Cumque provident alias vitae similique? Enim earum facilis dolorum minima veniam amet esse
                        tenetur beatae nulla sunt? Vel molestiae ea porro voluptate accusamus, nesciunt architecto!
                        Obcaecati cupiditate consequuntur, eos libero aperiam vero eligendi soluta quos nemo recusandae.
                        Labore nesciunt dicta optio quod quis. Minima ea, magnam minus voluptatum facere voluptatibus
                        maiores sint repellendus aut at! Odit natus laudantium veritatis fugiat illum molestias mollitia qui
                        distinctio dolores quas asperiores earum rerum culpa quis impedit, harum quos voluptates iste esse
                        magnam! Ipsa explicabo delectus a repellendus? Eum, assumenda aspernatur!</p>
                </div>
            </div>
        </div>
    </div>
